...
## Verificare la versione / forzare un aggiornamento

Il numero di versione è sempre visibile in-app, in alto nella **Home**, in **Gestione** e nella
scheda **Impostazioni**. Se hai appena aggiornato l'add-on e il numero non è cambiato,
l'aggiornamento non è ancora arrivato: vai su **Add-on Store → ⋮ → Controlla aggiornamenti**, e
se il problema persiste rimuovi e reinserisci l'URL del repository in **⋮ → Repository** per
forzare un clone pulito. Dettagli completi nel README del repository sorgente.
